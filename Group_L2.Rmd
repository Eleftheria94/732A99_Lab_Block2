...
elastic_net <- cv.glmnet(x = t(x_train), y = y_train, family = "multinomial", alpha = 0.5) #fitting the model, works onlly on multinomial
...
SVM  <- ksvm(x = x_train, kernel = "vanilladot", scale = FALSE) 
                
SVM_pred <- predict.ksvm(SVM, newdata = x_test) #fucking hell
