...
x_train <- t(train[, -2086]) # remove dependent variable
y_train <- train[[2086]] # vector of the dependent variable
...
1. What is nearest shrunken centroid classification? [2020]

[<http://statweb.stanford.edu/~tibs/PAM/Rdist/howwork.html>]

2. Nearest Shrunken Centroid as Feature Selection of Microarray Data [2020]
